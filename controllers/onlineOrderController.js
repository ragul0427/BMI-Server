...
const createOnlineOrder=async(req,res)=>{
    try {
        ...
        return res.status(500).send("Something went wrong while creating online order");
      }
}
const getOnlineOrder=async(req,res)=>{
    try {
        ...
        return res.status(500).send("Something went wrong while fetching online order");
      }
}
const updateOnlineOrder=async(req,res)=>{
    ...
    try {
      ...
      return res.status(500).send("Something went wrong while updating online order");
    }
}
...
module.exports={createOnlineOrder,getOnlineOrder,deleteOnlineOrder,updateOnlineOrder}
